function on_dark_social()   {
    ...
    document.getElementById('may-head').classList.replace('worksingle-heading','text-white')
    document.getElementById('may-head_sec').classList.replace('bg-white','bg-black')
    document.getElementById('may-intro').classList.replace('text-muted','text-light')
    document.getElementById('may-intro-head').classList.replace('text-primary-dark-mode','text-info')
    /* AAC Activity */
    document.getElementById('AAC-head_sec').classList.replace('bg-white','bg-black')
    document.getElementById('AAC-head').classList.replace('text-dark','text-white')
    document.getElementById('AAC-head').classList.replace('typo-space-aac','typo-space-aac-dark')
    /* Notes */
    /* Banner */
    document.getElementById('notes').classList.replace('bg-light','bg-black')
    document.getElementById('notes-head').classList.replace('typo-space-line-large','typo-space-line-large-dark')
    document.getElementById('notes-head').classList.replace('text-primary','text-info')
    /* Notes - Sub Head */
    document.getElementById('H').classList.replace('worksingle-heading','text-white')
    document.getElementById('G').classList.replace('worksingle-heading','text-white')
    document.getElementById('E').classList.replace('worksingle-heading','text-white')
    document.getElementById('DP').classList.replace('worksingle-heading','text-white')
    document.getElementById('pot-head').classList.replace('worksingle-heading','text-white')
    document.getElementById('pot-head').classList.replace('typo-space-line','typo-space-line-dark')
    /* Buttons */
    ...
    document.getElementById('a_17').classList.replace('btn-primary', 'btn-info');    document.getElementById('a_17').classList.add('btn-outline-primary')  /* 1 */
    document.getElementById('a_18').classList.replace('btn-primary', 'btn-info');    document.getElementById('a_18').classList.add('btn-outline-primary')  /* 1 */
    document.getElementById('a_19').classList.replace('btn-primary', 'btn-info');    document.getElementById('a_19').classList.add('btn-outline-primary')  /* 1 */
    document.getElementById('a_20').classList.replace('btn-primary', 'btn-info');    document.getElementById('a_20').classList.add('btn-outline-primary')  /* 2 */
    document.getElementById('a_21').classList.replace('btn-primary', 'btn-info');    document.getElementById('a_21').classList.add('btn-outline-primary')  /* 2 */
    document.getElementById('a_22').classList.replace('btn-primary', 'btn-info');    document.getElementById('a_22').classList.add('btn-outline-primary')  /* 2 */
    document.getElementById('a_23').classList.replace('btn-primary', 'btn-info');    document.getElementById('a_23').classList.add('btn-outline-primary')  /* 2 */
    /* Footer */
...
function off_dark_social()   {
    ...
    /* Activity */
    /* May Vacation Activity */
    document.getElementById('may-head').classList.replace('text-white','worksingle-heading')
    document.getElementById('may-head_sec').classList.replace('bg-black','bg-white')
    document.getElementById('may-intro').classList.replace('text-light','text-muted')
    document.getElementById('may-intro-head').classList.replace('text-info','text-primary-dark-mode')
    /* AAC Activity */
    document.getElementById('AAC-head_sec').classList.replace('bg-black','bg-white')
    document.getElementById('AAC-head').classList.replace('text-white','text-dark')
    document.getElementById('AAC-head').classList.replace('typo-space-aac-dark','typo-space-aac')
    /* Notes */
    /* Banner */
    document.getElementById('notes').classList.replace('bg-black','bg-light')
    document.getElementById('notes-head').classList.replace('typo-space-line-large-dark','typo-space-line-large')
    document.getElementById('notes-head').classList.replace('text-info','text-primary')
    /* Notes - Sub Head */
    document.getElementById('H').classList.replace('text-white','worksingle-heading')
    document.getElementById('G').classList.replace('text-white','worksingle-heading')
    document.getElementById('E').classList.replace('text-white','worksingle-heading')
    document.getElementById('DP').classList.replace('text-white','worksingle-heading')
    document.getElementById('pot-head').classList.replace('text-white','worksingle-heading')
    document.getElementById('pot-head').classList.replace('typo-space-line-dark','typo-space-line')
    /* Buttons */
    ...
    document.getElementById('a_17').classList.replace('btn-info', 'btn-primary');    document.getElementById('a_17').classList.remove('btn-outline-primary')  /* 1 */
    document.getElementById('a_18').classList.replace('btn-info', 'btn-primary');    document.getElementById('a_18').classList.remove('btn-outline-primary')  /* 1 */
    document.getElementById('a_19').classList.replace('btn-info', 'btn-primary');    document.getElementById('a_19').classList.remove('btn-outline-primary')  /* 1 */
    document.getElementById('a_20').classList.replace('btn-info', 'btn-primary');    document.getElementById('a_20').classList.remove('btn-outline-primary')  /* 2 */
    document.getElementById('a_21').classList.replace('btn-info', 'btn-primary');    document.getElementById('a_21').classList.remove('btn-outline-primary')  /* 2 */
    document.getElementById('a_22').classList.replace('btn-info', 'btn-primary');    document.getElementById('a_22').classList.remove('btn-outline-primary')  /* 2 */
    document.getElementById('a_23').classList.replace('btn-info', 'btn-primary');    document.getElementById('a_23').classList.remove('btn-outline-primary')  /* 2 */
    /* Footer */
